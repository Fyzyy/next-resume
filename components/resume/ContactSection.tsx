...
const styles = StyleSheet.create({
  ...
  icon: {
    width: resumeTheme.fontSize.sm,
    height: resumeTheme.fontSize.sm,
    marginRight: resumeTheme.spacing.sm,
  },
  contactText: {
    fontSize: resumeTheme.fontSize.sm,
    color: resumeTheme.colors.secondary,
  ...
  link: {
    color: resumeTheme.colors.link,
    textDecoration: "none",
  },
});

// Composants SVG pour les icônes avec nouvelles couleurs du thème
const EmailIcon = () => (
...
const LinkedInIcon = () => (
  <Svg style={styles.icon} viewBox="0 0 24 24">
    <Path
      ...
      fill={resumeTheme.colors.linkedin}
    />
  </Svg>
);
...
const GitHubIcon = () => (
  <Svg style={styles.icon} viewBox="0 0 24 24">
    <Path
      ...
      fill={resumeTheme.colors.github}
    />
  </Svg>
);
